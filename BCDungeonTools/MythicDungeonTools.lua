...
local LDB = LibStub("LibDataBroker-1.1"):NewDataObject("MythicDungeonTools", {
	...
	OnTooltipShow = function(tooltip)
		...
		tooltip:AddLine(mythicColor .."BC Dungeon Tools|r")
		tooltip:AddLine(L["Click to toggle AddOn Window"])
		tooltip:AddLine(L["Right-click to lock Minimap Button"])
	end,
})

SLASH_MYTHICDUNGEONTOOLS1 = "/bdt"
SLASH_MYTHICDUNGEONTOOLS2 = "/bcdungeontools"
...
local dungeonList = {
	[1] = L["Hellfire Ramparts"],
	[2] = L["The Blood Furnace"],
	[3] = L["The Shattered Halls"],
	[4] = L["Sethekk Halls"],
	[5] = L["Auchenai Crypts"],
	[6] = L["Shadow Labyrinth"],
	[7] = L["Mana Tombs"],
	[8] = L["The Slave Pens"],
	[9] = L["The Underbog"],
	[10] = L["The Steamvault"],	
	...
	[12] = L["The Arcatraz"],
	[13] = L["The Mechanar"],
	[14] = L["The Black Morass"],
	[15] = L["Old Hillsbrad Foothills"],
	[16] = L["Magisters' Terrace"],
}
...
local dungeonSubLevels = {
	...
	[2] = {
		[1] = L["The Blood Furnace"],
	}, 
	[3] = {
		[1] = L["The Shattered Halls"],
	}, 
	[4] = {
		[1] = L["Veil Sethekk"],
		[2] = L["Halls of Mourning"],
	}, 
	[5] = {
		[1] = L["Halls of the Hereafter"],
		[2] = L["Bridge of Souls"],
	}, 
	[6] = {
		[1] = L["Shadow Labyrinth"],
	}, 
	[7] = {
		[1] = L["Mana Tombs"],
	}, 
	...
	[10] = {
		[1] = L["The Steamvault"],
		[2] = L["The Cooling Pools"],
	}, 
	[11] = {
		[1] = L["The Botanica"],
	},
	[12] = {
		[1] = L["Stasis Block: Trion"],
		[2] = L["Stasis Block: Maximus"],
		[3] = L["Containment Core"],
	}, 
	[13] = {
		[1] = L["The Mechanar"],
		[1] = L["Calculation Chamber"],
	}, 
	[14] = {
		[1] = L["The Black Morass"],
	}, 
	[15] = {
		[1] = L["Old Hillsbrad Foothills"],
	}, 
	[16] = {
		[1] = L["Grand Magister's Asylum"],
		[2] = L["Observation Grounds"],
	}, 
}
...
MDT.dungeonMaps = {
	...
	[15] = {
		[0] = "CoTHillsbradFoothills",
		[1] = "CoTHillsbradFoothills",
	},
	[16] = {
		[0] = "MagistersTerrace",
		[1] = "MagistersTerrace1_",
		[2] = "MagistersTerrace2_",
	},
}
MDT.dungeonBosses = {}
MDT.dungeonEnemies = {}
...
function MDT:MakeTopBottomTextures(frame)
	...
	if frame.topPanel == nil then
		...
		frame.topPanelString:SetText("BC Dungeon Tools")
...
function MDT:MakePullSelectionButtons(frame)
	...
	frame.optionsDropDown = LDD:Create_UIDropDownMenu("PullButtonsOptionsDropDown", nil)
end
...
function MDT:UpdatePullButtonNPCData(idx)
	...
	local totalForcesMax = 1
	if MDT.dungeonTotalCount[db.currentDungeonIdx] then 
		totalForcesMax = MDT:IsCurrentPresetTeeming() and MDT.dungeonTotalCount[db.currentDungeonIdx].teeming or MDT.dungeonTotalCount[db.currentDungeonIdx].normal 
	end
...
function initFrames()
	...
	main_frame.contextDropdown = LDD:Create_UIDropDownMenu("MDTContextDropDown", nil)
